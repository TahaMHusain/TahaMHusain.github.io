const HTMLTempls = {
    ...
    selectNamePage: `
        <form>
            <input type="submit" id="name-entry" name="name-entry" placeholder="Name"></input>
            <button class="startup" id="join-or-create-room-button"></button>  
        </form>
    `,
    waitingRoomPage: `
        <p class="startup" id="waiting-msg"></p>
    `
};
export {HTMLTempls};